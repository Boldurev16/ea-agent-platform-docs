...
Диаграммы показывают не только технические вызовы, но и архитектурные контуры: где возникает решение, где появляется источник, где фиксируется состояние и где возможна деградация.
