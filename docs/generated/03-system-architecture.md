...
Материал описывает санитизированную архитектурную картину. Имена модулей оставлены как ориентиры, но без исходного кода, секретов и приватных конфигураций.
