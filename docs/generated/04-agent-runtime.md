...
Agent runtime — это управляемый цикл рассуждения агента. Он отделяет “модель умеет генерировать текст” от “система умеет дать проверяемый архитектурный ответ”.
...
## 7. Потоковые и синхронные ответы (Streaming и sync)
