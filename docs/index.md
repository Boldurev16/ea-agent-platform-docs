---
title: Описание ea-agent-platform
description: Русскоязычный материал по архитектуре агентной системы для управления корпоративной архитектурой.
---

# ea-agent-platform — обзор агентной системы для управления корпоративной архитектурой
